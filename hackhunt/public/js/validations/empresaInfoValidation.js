window.onload = function () {
    ...
    formInputs = formInputs.filter(input => {
        return input.getAttribute('id') != 'cmp_tel' && input.getAttribute('id') != 'cmp_avatar' && input.getAttribute(
            'id'
        ) != 'cmp_user_gender' && input.getAttribute('id') != 'cmp_description' && input.getAttribute(
            'id'
        ) != 'cmp_avatar'
    })
